...
#         ls = len(s)
#         for maxlen in reversed(range(ls)):
#             stind = 0
#             enind = maxlen
#             for slide in range(ls - maxlen):
#                 subs = s[stind+slide:enind+slide+1]
#                 if subs == subs[::-1]:
#                     return subs
#         return s

#Manacher's algorithm; https://snuke.hatenablog.com/entry/2014/12/02/235837
